...
PROTOBUF_NAMESPACE_OPEN
template<> ::graph_profile::Profile* Arena::CreateMaybeMessage<::graph_profile::Profile>(Arena*);
template<> ::graph_profile::Profile_Adjacents* Arena::CreateMaybeMessage<::graph_profile::Profile_Adjacents>(Arena*);
template<> ::graph_profile::Profile_Op* Arena::CreateMaybeMessage<::graph_profile::Profile_Op>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace graph_profile {
...
enum Profile_Op_MemType : int {
  ...
  Profile_Op_MemType_Profile_Op_MemType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  Profile_Op_MemType_Profile_Op_MemType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
...
enum Profile_Op_OpType : int {
  ...
  Profile_Op_OpType_Profile_Op_OpType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  Profile_Op_OpType_Profile_Op_OpType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
...
template <> struct is_proto_enum< ::graph_profile::Profile_Op_MemType> : ::std::true_type {};
template <>
...
template <> struct is_proto_enum< ::graph_profile::Profile_Op_OpType> : ::std::true_type {};
template <>
